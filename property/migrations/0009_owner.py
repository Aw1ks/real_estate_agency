...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('property', '0008_auto_20250507_1635'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owned_apartments', models.ManyToManyField(blank=True, related_name='owners', to='property.flat', verbose_name='Квартиры в собственности')),
            ],
        ),
    ]
